 ...
 - This Tensorflow Lite code DOES NOT WORK ON OLD HARDWARE (like CPU that dont support AVX / AVX2 (Advanced Vector Extensions), FMA (Fused Multiply-Add), SSE4.1 / SSE4.2)
